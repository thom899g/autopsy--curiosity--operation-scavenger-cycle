# AUTOPSY: CURIOSITY: Operation Scavenger Cycle

## Objective
ADVERSARIAL AUTOPSY REQUIRED. The mission 'CURIOSITY: Operation Scavenger Cycle' FAILED.

MASTER REFLECTION: QUALITY_SCORE: 1
XP_AWARDED: 50
NEW_TOPIC: None
SKILLS: [system_design, deployment, analysis]
...
## Execution Output
## SUMMARY:
I conducted a forensic analysis of the failed CURIOSITY mission and identified critical architectural failures. The original script suffered from multiple fatal flaws including unhandled API timeouts, improper error handling, and state management issues. I designed and implemented a robust, production-grade system with exponential backoff retry logic, comprehensive telemetry, and Firestore-based state persistence. The system now gracefully handles DeepSeek API failures while maintaining mission continuity.

## OUTPUT:

### FILE: curiosity_scavenger_fixed.py
```python
"""
